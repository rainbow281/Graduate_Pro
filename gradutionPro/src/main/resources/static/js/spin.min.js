! function(t, i) {
    "object" == typeof exports ? module.exports = i() : "function" == typeof define && define.amd ? define(i) : t.Spinner =
        i()
}(this, function() {
    "use strict";
    ...
    function e(t, i, e, o) {
        var n = ["opacity", i, ~~(100 * t), e, o].join("-"),
            ...
            c = a && "-" + a + "-" || "";
        return d[n] || (p.insertRule("@" + c + "keyframes " + n + "{0%{opacity:" + s + "}" + r + "%{opacity:" + t + "}" + (r +
            .01) + "%{opacity:1}" + (r + i) % 100 + "%{opacity:" + t + "}100%{opacity:" + s + "}}", p.cssRules.length), d[n] =
            1), n
    }
    ...
    a.defaults = {}, r(a.prototype, {
        spin: function(i) {
            ...
            if (n(r, {
                ...
                ! function t() {
                    a++;
                    for (var i = 0; i < o.lines; i++) s = Math.max(1 - (a + (o.lines - i) * f) % p * u, o.opacity), e.opacity(r, i *
                        o.direction + c, s, o);
    ...
    return !o(f, "transform") && f.adj ? function() {
        ...
        p.addRule(".spin-vml", "behavior:url(#default#VML)"), a.prototype.lines = function(t, o) {
            ...
            var n = t.firstChild;
            o = o.shadow && o.lines || 0, n && i + o < n.childNodes.length && (n = (n = (n = n.childNodes[i + o]) && n.firstChild) &&
                n.firstChild) && (n.opacity = e)
        }
    }() : l = o(f, "animation"), a
});
